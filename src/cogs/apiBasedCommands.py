    ...
    async def get_github_userdata(self, ctx, username: str):
        ...
        async with ctx.typing():
            try:
                ...
                embed = create_embed(ctx, title=user_data['name'], description=user_data["company"], color=discord.Color.dark_gold())
                embed.add_field(
    ...
    async def get_weather(self, ctx, *args):
        ...
        async with ctx.typing():
            try:
                ...
                embed = create_embed(ctx, title=f'{weather_data["city"]["name"]} - {weather_data["city"]["country"]}', color=discord.Color.dark_gold())
                embed.add_field(
